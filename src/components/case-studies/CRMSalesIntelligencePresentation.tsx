...
export default function CRMSalesIntelligencePresentation() {
          ...
          <div className="min-w-0 flex-1 w-full max-w-[1320px]">
            ...
            <div className="relative w-full overflow-hidden rounded-xl border border-[#1c4c79] bg-[#071525] p-2 shadow-[0_30px_100px_rgba(0,50,110,.3)] sm:p-3 lg:p-4">
              ...
              <button
                ...
                className="absolute left-8 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-[#20476e] bg-[#07192b]/90 text-[#75beff] shadow-lg transition hover:border-[#3f81b9] hover:bg-[#0a2440] hover:text-white"
              >
                <ArrowLeft size={17} />
              </button>
              ...
              <button
                ...
                className="absolute right-8 top-1/2 z-10 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-[#20476e] bg-[#07192b]/90 text-[#75beff] shadow-lg transition hover:border-[#3f81b9] hover:bg-[#0a2440] hover:text-white"
              >
                <ArrowRight size={17} />
              </button>
