...
import { procurementManagementProject as project } from "@/data/procurement-management";

export default function ProcurementManagementPresentation() {
    ...
    <main className="min-h-screen bg-[#020812] text-white">
      ...
      <div className="flex min-h-screen flex-col">
        ...
        <header className="flex items-center justify-between border-b border-[#14375c] bg-[#041120]/95 px-4 py-3 backdrop-blur sm:px-6">
          ...
          <Link
            href="/case-studies/procurement-management"
          ...
          <div className="min-w-0 flex-1 w-full max-w-[1320px]">
            ...
            <div className="relative w-full overflow-hidden rounded-xl border border-[#1c4c79] bg-[#071525] p-2 shadow-[0_30px_100px_rgba(0,50,110,.3)] sm:p-3 lg:p-4">
              ...
              <button
                ...
                className="absolute left-6 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-[#20476e] bg-[#07192b]/90 text-[#75beff] shadow-lg transition hover:border-[#3f81b9] hover:bg-[#0a2440] hover:text-white"
              >
                <ArrowLeft size={17} />
              </button>
              ...
              <button
                ...
                className="absolute right-6 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-[#20476e] bg-[#07192b]/90 text-[#75beff] shadow-lg transition hover:border-[#3f81b9] hover:bg-[#0a2440] hover:text-white"
              >
                <ArrowRight size={17} />
              </button>
      ...
      {isFullscreen && (
        <div className="fixed inset-0 z-50 flex min-h-screen flex-col bg-[#01050b]">

          <header className="flex items-center justify-between border-b border-white/10 bg-[#030b15]/95 px-4 py-3 sm:px-6">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-md border border-white/10 bg-white/5 px-3 py-2 text-[10px] text-[#a9c2da] transition hover:border-white/20 hover:text-white"
            >
              Exit
            </button>
          ...
          <div className="flex flex-1 items-center justify-center px-4 py-6 sm:px-8">
            ...
            <button
              onClick={previousSlide}
              aria-label="Previous dashboard"
              className="mr-4 hidden h-12 w-12 shrink-0 items-center justify-center rounded-full border border-[#20476e] bg-[#07192b] text-[#75beff] transition hover:border-[#3f81b9] hover:bg-[#0a2440] hover:text-white md:flex"
            >
              <ArrowLeft size={20} />
            </button>
            ...
            <div className="w-full max-w-[1500px]">
              ...
              <div className="relative aspect-[16/9] w-full overflow-hidden rounded-xl border border-[#1c4c79] bg-[#020a14] shadow-[0_30px_100px_rgba(0,50,110,.4)]">
                ...
                <Image
                  ...
                  fill
                  priority
                  className="object-contain p-3 sm:p-5 lg:p-8"
                  sizes="100vw"
                />

                <div className="absolute bottom-5 left-1/2 -translate-x-1/2 rounded-full border border-[#285579] bg-[#041120]/90 px-4 py-2 text-[10px] text-[#b9cce0] backdrop-blur">
                  {String(activeSlide + 1).padStart(2, "0")}
                  {" / "}
                  {String(project.dashboards.length).padStart(2, "0")}
                </div>
            ...
            <button
              onClick={nextSlide}
              aria-label="Next dashboard"
              className="ml-4 hidden h-12 w-12 shrink-0 items-center justify-center rounded-full border border-[#20476e] bg-[#07192b] text-[#75beff] transition hover:border-[#3f81b9] hover:bg-[#0a2440] hover:text-white md:flex"
            >
              <ArrowRight size={20} />
            </button>
