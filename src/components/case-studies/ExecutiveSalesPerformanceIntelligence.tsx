            ...
            <div className="flex aspect-[16/9] items-center justify-center overflow-hidden rounded-lg border border-[#173d64] bg-[#081a2d] p-5 sm:p-7 lg:p-9">
              ...
              <div className="relative h-full w-full overflow-hidden rounded-md border border-[#214a72] bg-[#061321] shadow-[0_15px_50px_rgba(0,0,0,.35)]">
                ...
                <Image
                  ...
                  alt="Executive Sales Performance Intelligence dashboard"
                  fill
                  priority
  ...
  <div className="mt-7 overflow-visible">
    ...
    <div className="flex gap-4 overflow-x-auto px-2 pb-6 pt-3 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
      ...
      {project.dashboards.map((dashboard, index) => (
        ...
        <Link
          key={dashboard.title}
          href={`/case-studies/executive-sales-performance-intelligence/dashboard?slide=${index}`}
          target="_blank"
          rel="noopener noreferrer"
        ...
        <section className="mt-4 rounded-[12px] border border-[#174574] bg-[#061426]/85 p-4 sm:p-5">
          ...
          <div className="mt-5 overflow-hidden rounded-lg border border-[#1c456e] bg-[#0b111a] p-2 sm:p-4">
            ...
            <Image
              ...
              alt="Executive Sales Performance Intelligence data model"
              width={1675}
              height={637}
        ...
        <section className="mt-4 grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <div className="rounded-[12px] border border-[#174574] bg-[#061426]/85 p-5">
            ...
            <p className="mt-4 text-[12px] leading-6 text-[#a9bdd2]">
              A real-estate sales intelligence case study demonstrating how fragmented commercial data can be structured into an executive reporting system that connects sales activity, conversion, cancellations, team performance, and inventory exposure.
            </p>
