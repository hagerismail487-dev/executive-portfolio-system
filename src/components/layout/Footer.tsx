...
<div>
              <div className="grid grid-cols-1 items-center gap-4 py-0 lg:grid-cols-[250px_1fr_160px]">
              {/* ================= Brand ================= */}
              ...
              <div className="flex items-center justify-self-start gap-3">
                ...
                <div>
                  <h3 className="text-[14px] font-bold leading-none tracking-tight">
                    Hager Ismail
                  </h3>
...
"
                ...
                <Link
                  href="/#business-value"
                  className="relative text-[13px] text-slate-300 transition-all duration-300 hover:text-white after:absolute after:-bottom-2 after:left-0 after:h-[2px] after:w-0 after:bg-[#3B82F6] after:transition-all hover:after:w-full"
                >
                  Business Value
                </Link>
                ...
                <Link
                  href="/#contact"
                  className="relative text-[13px] text-white after:absolute after:-bottom-[8px] after:left-0 after:h-[2px] after:w-full after:bg-[#3B82F6]"
                >
                  Contact
                </Link>
              </nav>
              ...
              <div className="flex items-center justify-self-end gap-4">
                ...
                <a
                  ...
                  className="group flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-white/5 transition-all duration-300 hover:-translate-y-1 hover:border-[#3B82F6]"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="h-[14px] w-[14px] text-slate-300 transition duration-300 group-hover:text-[#60A5FA]"
                  >
                ...
                <a
                  ...
                  className="group flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-white/5 transition-all duration-300 hover:-translate-y-1 hover:border-white/20"
                >
                  <Mail className="h-[15px] w-[15px] text-slate-300 transition group-hover:text-white" />
                </a>
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 24 24"
                    fill="currentColor"
                    className="h-[16px] w-[16px] text-slate-300 transition duration-300 group-hover:text-white"
                  >
