    ...
    <footer className="relative overflow-hidden bg-gradient-to-br from-[#102A56] via-[#0F274A] to-[#0B1E3B] text-white">
      ...
      <Container>
        <div className="relative z-10 py-10">
          ...
          <div className="flex flex-col gap-10">
            <div className="grid grid-cols-1 items-center gap-8 py-2 lg:grid-cols-[300px_1fr_180px]">
              ...
              <nav className="flex items-center justify-center gap-5">
                ...
                <Link
                  href="/#contact"
                  className="relative text-[14px] text-white after:absolute after:-bottom-[8px] after:left-0 after:h-[2px] after:w-full after:bg-[#3B82F6]"
                >
                  Contact
                </Link>
              </nav>
          ...
          <div className="mb-6 mt-8 h-px bg-gradient-to-r from-transparent via-white/15 to-transparent" />
